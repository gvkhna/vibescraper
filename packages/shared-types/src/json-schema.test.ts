...
describe('Meta-Schema Validation Tests', () => {
  test('Valid schema conforming to object-root meta-schema', () => {
  ...
  test('Invalid schema not conforming to object-root meta-schema', () => {
...
describe('Primary Key Format Tests', () => {
  ...
  test('Valid schema - x-primary-key is true', () => {
    const validSchema: JsonObject = {
      type: 'object',
      properties: {
        id: {
  ...
  test('Invalid schema - x-primary-key is not true', () => {
    const invalidSchema: JsonObject = {
      type: 'object',
      properties: {
        id: {
...
describe('Root Primary Key Tests', () => {
  test('Valid schema - has root x-primary-key string', () => {
    const validSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
  ...
  test('Invalid schema - missing root x-primary-key', () => {
    const invalidSchema: JsonObject = {
      type: 'object',
      properties: {
        id: {type: 'string'},
...
describe('Primary Key Reference Tests', () => {
  ...
  test('Valid schema - primary key property exists and is required', () => {
    const validSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
  ...
  test('Invalid schema - missing required array', () => {
    const invalidSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
...
describe('$data Reference Tests', () => {
  test('$data reference works - smaller/larger example', () => {
    const schema: JsonObject = {
      properties: {
        smaller: {
          type: 'number',
...
describe('Primary Key in Required Tests', () => {
  test('Valid schema - primary key in required array', () => {
    const validSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
  ...
  test('Invalid schema - primary key not in required array', () => {
    const invalidSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
...
describe('Combined Schema Requirements Tests', () => {
  test('Valid schema passes all requirements', () => {
    const validSchema: JsonObject = {
      type: 'object',
      'x-primary-key': 'id',
      properties: {
    ...
    const result = validateMetaSchemas(validSchema)
    if (!result.success) {
  ...
  test('Invalid schema missing requirements', () => {
    const invalidSchema: JsonObject = {
    ...
    const result = validateMetaSchemas(invalidSchema)
    expect(result.success).toBe(false)
