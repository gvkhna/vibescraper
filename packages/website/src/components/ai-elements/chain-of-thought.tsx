...
export const ChainOfThoughtHeader = memo(({ className, children, ...props }: ChainOfThoughtHeaderProps) => {
  ...
  return (
    ...
    >
      <CollapsibleTrigger
        className={cn(
          `text-muted-foreground hover:text-foreground flex w-full items-center gap-2 text-sm
          transition-colors`,
          className
        )}
        {...props}
    ...
    <Collapsible open={isOpen}>
      <CollapsibleContent
        className={cn(
          ...
          data-[state=open]:slide-in-from-top-2 text-popover-foreground data-[state=closed]:animate-out
...
export const ChainOfThoughtImage = memo(
  ({ className, children, caption, ...props }: ChainOfThoughtImageProps) => (
    ...
    >
      <div
        className='bg-muted relative flex max-h-[22rem] items-center justify-center overflow-hidden rounded-lg
          p-3'
      >
        {children}
      </div>
