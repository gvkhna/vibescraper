...
function Sparkline({ color = "#3B82F6" }: { color?: string }) {
  return (
    <svg width="100" height="32" viewBox="0 0 100 32" className="opacity-80">
      <polyline
        fill="none"
        stroke={color}
        strokeWidth="2"
...
export function GlassCard({
  ...
  return (
    <Card
      className={cn(
        "bg-[rgba(26,26,27,0.5)] backdrop-blur-md border border-white/10 text-white shadow-[0_8px_24px_rgba(0,0,0,0.3)]",
        "rounded-xl",
        className
      )}
    >
