  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        ...
        data-[state=open]:text-accent-foreground flex items-center rounded-sm px-2 py-1 text-sm font-medium
    ...
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          ...
          origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-md`,
          className
        )}
        {...props}
      />
