...
CREATE TABLE "crawler" (
	...
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "crawler_publicId_unique" UNIQUE("publicId")
);
...
CREATE TABLE "projectCommit" (
	...
	"cachedData" jsonb,
	"cachedAt" timestamp,
	"recentUrls" jsonb DEFAULT '{"urls":[]}'::jsonb NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "crawlUrl" ADD CONSTRAINT "crawlUrl_crawlRunId_project_id_fk" FOREIGN KEY ("crawlRunId") REFERENCES "public"."project"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "crawlUrl" ADD CONSTRAINT "crawlUrl_storageId_storage_id_fk" FOREIGN KEY ("storageId") REFERENCES "public"."storage"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "crawler" ADD CONSTRAINT "crawler_projectId_project_id_fk" FOREIGN KEY ("projectId") REFERENCES "public"."project"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "extractionRun" ADD CONSTRAINT "extractionRun_crawlUrlId_crawlUrl_id_fk" FOREIGN KEY ("crawlUrlId") REFERENCES "public"."crawlUrl"("id") ON DELETE cascade ON UPDATE no action;
...
CREATE UNIQUE INDEX "crawlUrl_crawlRunId_url_index" ON "crawlUrl" USING btree ("crawlRunId","url");
CREATE UNIQUE INDEX "crawler_projectId_version_index" ON "crawler" USING btree ("projectId","version");
CREATE UNIQUE INDEX "crawler_publicId_index" ON "crawler" USING btree ("publicId");
...
CREATE UNIQUE INDEX "extractionRun_crawlUrlId_extractorId_index" ON "extractionRun" USING btree ("crawlUrlId","extractorId");
