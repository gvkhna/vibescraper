...
export function DataTabPopoverContent() {
  ...
  if (!extractionResult) {
    return <div className='text-sm text-white/70'>No extraction data available</div>
  }
  ...
  return (
    <div className='space-y-3'>
      ...
      >
        {copiedToClipboard ? <CheckCircle className='mr-2 h-4 w-4' /> : <Copy className='mr-2 h-4 w-4' />}
