...
interface ExtractionTabsDropdownProps {
  tabs: DropdownTab[]
  activeTab: ExtractionPanelTabType
  lastDropdownTab?: ExtractionPanelTabType
  onTabChange: (value: ExtractionPanelTabType) => void
}

export function ExtractionTabsDropdown({tabs, activeTab, lastDropdownTab, onTabChange}: ExtractionTabsDropdownProps) {
