...
import {Play, RefreshCw, Trash2, Clock, HardDrive, Download, CheckCircle2, AlertCircle} from 'lucide-react'
      ...
      >
        <div className='space-y-4'>
          ...
          <div className='text-xs text-white/40'>
            {cacheInfo?.isCached
              ? 'Click outside to dismiss • Cache improves performance'
              : 'No cache available • Will fetch fresh data'}
          </div>
        </div>
      </HoverCardContent>
    </HoverCard>
